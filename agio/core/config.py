...
env_file_path = local_dirs.config_dir() / 'core_config.env'
...
class WorkspaceSettings(_BaseSettings):
    ...
    RESOURCES_DIR: str = ""
    CACHE_ROOT: str = local_dirs.cache_dir().as_posix()
    INSTALL_DIR: str = local_dirs.workspaces_install_dir().as_posix()
